<template>
  <div class="flex gap-4 py-4">
    <div v-for="product in props.products" :key="product.id" class="relative  w-[200px] h-[350px] border rounded-lg overflow-hidden flex flex-col justify-center items-center">
